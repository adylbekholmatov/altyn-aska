(() => {
  ...
  /* ==========================================================
     ...
     ========================================================== */
  const EVENT = {
    start: '2026-09-25T14:00:00+06:00', // дата и время начала (часовой пояс Кыргызстана +06:00)
    time: '14:00',                      // как время показывается на сайте
    durationHours: 3,
  };
  ...
  const TEXT = {
    ...
    'gal.3.t': 'Комплекстин башкы блогу',
